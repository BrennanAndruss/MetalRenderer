...
class ShadowPass {
    ...
    init(device: MTLDevice, library: MTLLibrary) {
        ...
        shadowMapDescriptor.usage = [MTLTextureUsage.shaderRead, MTLTextureUsage.renderTarget]
    ...
    func encode(commandBuffer: MTLCommandBuffer, depthStencilState: MTLDepthStencilState,
                render: (MTLRenderCommandEncoder) -> Void, viewProjMatrix: inout float4x4) {
